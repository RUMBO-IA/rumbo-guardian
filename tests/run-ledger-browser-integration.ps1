...
$browser = Start-Process -FilePath $brave -ArgumentList @("--remote-debugging-port=$port","--user-data-dir=$profile",'--no-first-run','--no-default-browser-check','about:blank') -PassThru
try {

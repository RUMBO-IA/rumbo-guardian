...
## Portfolio narrative
RUMBO Guardian demonstrates a modular security architecture: a shared risk engine, an operator-facing web application, an evidence ledger, domain context controls and a browser extension that performs explicit, on-demand page inspection.
